...
const PRODUCTS = [
  {
    ...
    weight: '250g',
    description:
      'Creamy butter blended with pure honey and natural honeycomb for a rich, naturally sweet spread.',
    ingredients: ['Pure creamy butter', '100% pure honey', 'Natural honeycomb', 'Pure cane sugar'],
